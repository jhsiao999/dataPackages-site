...
counts <- cbind(counts_day0, counts_day2, counts_day4)

colnames(counts) <- c(paste0("sample.0.",c(1:NCOL(counts_day0))),
                      paste0("sample.2.",c(1:NCOL(counts_day2))),
                      paste0("sample.4.",c(1:NCOL(counts_day4))) )
...
col_data <- data.frame(
  ...
  day = c( rep(0, length(colnames(counts_day0))), rep(2, length(colnames(counts_day2))),
           rep(4, length(colnames(counts_day4)))  )) 
