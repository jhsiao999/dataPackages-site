---
title: "Making MousePatelGlioblastoma package"
author: "Joyce Hsiao"
date: "2016-08-26"
output:
  html_document:
...
counts <- data.frame(
    fread('../data/MousePatelGlioblastoma/GSE57872_GBM_data_matrix.txt'),
    row.names = 1)
...
MousePatelGlioblastoma <- new("ExpressionSet",
                ...
                experimentData = new("MIAME",
                                     title = "Patel Mouse Glioblastoma"))


save(MousePatelGlioblastoma,
        file = "../data/all-rda/MousePatelGlioblastoma.rda")
```
